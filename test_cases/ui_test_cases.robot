...
Verify The Items, Price, Quantity, And Total When Checkout With The Correct First name, Last name, And Postal code
    [Setup]       Run Keywords    Remove Test Result Screenshots File In Test Case ID Folder    AND    Create Test Case ID Folder
    ...
    Verify The Items, Price, And Quantity On The Cart Page          expected_selected_items=${product_list}    step=5
    ...
    Verify The Items, Price, Quantity, Total, And Total With Tax    expected_selected_items=${product_list}    step=9
    Click Finish Button                                             step=10
    Verify The Checkout Successful Message                          step=11

Verify The Error Message When Checkout By Leaving The First Name Field Empty On The Checkout Step 1 Page
    [Setup]       Run Keywords    Remove Test Result Screenshots File In Test Case ID Folder    AND    Create Test Case ID Folder
    ...
    Click Continue Button                                           step=8
    Verify The Error Message                                        error_message_locator=${checkout_step_1_page_first_name_is_required_error_message}    step=9

Verify The Error Message When Checkout By Leaving The Last Name Field Empty On The Checkout Step 1 Page
    [Setup]       Run Keywords    Remove Test Result Screenshots File In Test Case ID Folder    AND    Create Test Case ID Folder
    ...
    Click Continue Button                                           step=8
    Verify The Error Message                                        error_message_locator=${checkout_step_1_page_last_name_is_required_error_message}    step=9

Verify The Error Message When Checkout By Leaving The Postal Code Field Empty On The Checkout Step 1 Page
    [Setup]       Run Keywords    Remove Test Result Screenshots File In Test Case ID Folder    AND    Create Test Case ID Folder
    ...
    Click Continue Button                                           step=8
    Verify The Error Message                                        error_message_locator=${checkout_step_1_page_postal_code_is_required_error_message}    step=9